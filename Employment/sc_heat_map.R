...
abbeville<- fredr(series_id= "SCABBE1URN", observation_start = as.Date("2022-02-01"))
...
aiken<- fredr(series_id= "SCAIKE0URN", observation_start = as.Date("2022-02-01"))
aiken<-aiken[,c(2:3)]
colnames(aiken)<-c("subregion","Unemployment Rate")
aiken$subregion=recode(aiken$subregion, "SCAIKE0URN" = "aiken")

allendale<- fredr(series_id= "SCALLE5URN", observation_start = as.Date("2022-02-01"))
...
anderson<- fredr(series_id= "SCANDE7URN", observation_start = as.Date("2022-02-01"))
...
bamberg<- fredr(series_id= "SCBAMB9URN", observation_start = as.Date("2022-02-01"))
...
barnwell<- fredr(series_id= "SCBARN1URN", observation_start = as.Date("2022-02-01"))
...
beaufort<- fredr(series_id= "SCBEAU5URN", observation_start = as.Date("2022-02-01"))
...
berkeley<- fredr(series_id= "SCBERK0URN", observation_start = as.Date("2022-02-01"))
...
calhoun<- fredr(series_id= "SCCALH7URN", observation_start = as.Date("2022-02-01"))
...
charleston<- fredr(series_id= "SCCHAR9URN", observation_start = as.Date("2022-02-01"))
...
cherokee<- fredr(series_id= "SCCHER1URN", observation_start = as.Date("2022-02-01"))
...
chester<- fredr(series_id= "SCCHES3URN", observation_start = as.Date("2022-02-01"))
...
chesterfield<- fredr(series_id= "SCCHES5URN", observation_start = as.Date("2022-02-01"))
...
clarendon<- fredr(series_id= "SCCLAR7URN", observation_start = as.Date("2022-02-01"))
...
colleton<- fredr(series_id= "SCCOLL9URN", observation_start = as.Date("2022-02-01"))
...
darlington<- fredr(series_id= "SCDARL5URN", observation_start = as.Date("2022-02-01"))
...
dillon<- fredr(series_id= "SCDILL3URN", observation_start = as.Date("2022-02-01"))
dillon<-dillon[,c(2:3)]
colnames(dillon)<-c("subregion","Unemployment Rate")
dillon$subregion=recode(dillon$subregion, "SCDILL3URN" = "dillon")

dorchester<- fredr(series_id= "SCDORC7URN", observation_start = as.Date("2022-02-01"))
...
edgefield<- fredr(series_id= "SCEDGE7URN", observation_start = as.Date("2022-02-01"))
...
fairfield<- fredr(series_id= "SCFAIR9URN", observation_start = as.Date("2022-02-01"))
...
florence<- fredr(series_id= "SCFLOR0URN", observation_start = as.Date("2022-02-01"))
...
georgetown<- fredr(series_id= "SCGEOR3URN", observation_start = as.Date("2022-02-01"))
...
greenville<- fredr(series_id= "SCGREE5URN", observation_start = as.Date("2022-02-01"))
...
greenwood<- fredr(series_id= "SCGREE0URN", observation_start = as.Date("2022-02-01"))
...
hampton<- fredr(series_id= "SCHAMP9URN", observation_start = as.Date("2022-02-01"))
...
horry<- fredr(series_id= "SCHORR1URN", observation_start = as.Date("2022-02-01"))
horry<-horry[,c(2:3)]
colnames(horry)<-c("subregion","Unemployment Rate")
horry$subregion=recode(horry$subregion, "SCHORR1URN" = "horry")

jasper<- fredr(series_id= "SCJASP3URN", observation_start = as.Date("2022-02-01"))
jasper<-jasper[,c(2:3)]
colnames(jasper)<-c("subregion","Unemployment Rate")
jasper$subregion=recode(jasper$subregion, "SCJASP3URN" = "jasper")

kershaw<- fredr(series_id= "SCKERS5URN", observation_start = as.Date("2022-02-01"))
...
lancaster<- fredr(series_id= "SCLANC7URN", observation_start = as.Date("2022-02-01"))
...
laurens<- fredr(series_id= "SCLAUR5URN", observation_start = as.Date("2022-02-01"))
...
lee<- fredr(series_id= "SCLEEC1URN", observation_start = as.Date("2022-02-01"))
lee<-lee[,c(2:3)]
colnames(lee)<-c("subregion","Unemployment Rate")
lee$subregion=recode(lee$subregion, "SCLEEC1URN" = "lee")

lexington<- fredr(series_id= "SCLEXI0URN", observation_start = as.Date("2022-02-01"))
...
marion<- fredr(series_id= "SCMARI7URN", observation_start = as.Date("2022-02-01"))
marion<-marion[,c(2:3)]
colnames(marion)<-c("subregion","Unemployment Rate")
marion$subregion=recode(marion$subregion, "SCMARI7URN" = "marion")

marlboro<- fredr(series_id= "SCMARL9URN", observation_start = as.Date("2022-02-01"))
...
mccormick<- fredr(series_id= "SCMCCO5URN", observation_start = as.Date("2022-02-01"))
...
newberry<- fredr(series_id= "SCNEWB1URN", observation_start = as.Date("2022-02-01"))
...
oconee<- fredr(series_id= "SCOCON3URN", observation_start = as.Date("2022-02-01"))
oconee<-oconee[,c(2:3)]
colnames(oconee)<-c("subregion","Unemployment Rate")
oconee$subregion=recode(oconee$subregion, "SCOCON3URN" = "oconee")

orangeburg<- fredr(series_id= "SCORAN5URN", observation_start = as.Date("2022-02-01"))
...
pickens<- fredr(series_id= "SCPICK0URN", observation_start = as.Date("2022-02-01"))
...
richland<- fredr(series_id= "SCRICH9URN", observation_start = as.Date("2022-02-01"))
...
saluda<- fredr(series_id= "SCSALU1URN", observation_start = as.Date("2022-02-01"))
saluda<-saluda[,c(2:3)]
colnames(saluda)<-c("subregion","Unemployment Rate")
saluda$subregion=recode(saluda$subregion, "SCSALU1URN" = "saluda")

spartanburg<- fredr(series_id= "SCSPAR0URN", observation_start = as.Date("2022-02-01"))
...
sumter<- fredr(series_id= "SCSUMT5URN", observation_start = as.Date("2022-02-01"))
sumter<-sumter[,c(2:3)]
colnames(sumter)<-c("subregion","Unemployment Rate")
sumter$subregion=recode(sumter$subregion, "SCSUMT5URN" = "sumter")

union<- fredr(series_id= "SCUNIO7URN", observation_start = as.Date("2022-02-01"))
union<-union[,c(2:3)]
colnames(union)<-c("subregion","Unemployment Rate")
union$subregion=recode(union$subregion, "SCUNIO7URN" = "union")

williamsburg<- fredr(series_id= "SCWILL9URN", observation_start = as.Date("2022-02-01"))
...
york<- fredr(series_id= "SCYORK5URN", observation_start = as.Date("2022-02-01"))
york<-york[,c(2:3)]
